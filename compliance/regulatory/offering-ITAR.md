...
Microsoft provides certain cloud services or service features that can support customers to meet ITAR obligations. While there is no compliance certification for the ITAR, Microsoft operates and has designed in-scope services to be capable of supporting a customer's ITAR obligations and compliance program.  
